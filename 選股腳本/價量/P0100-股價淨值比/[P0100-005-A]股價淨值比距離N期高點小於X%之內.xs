{@type:filter}
// 腳本類型: 選股腳本
// 腳本名稱: 股價淨值比距離N期高點小於X%之內
// 顯示名稱: 股價淨值比距離[1年]高點小於[1]%之內
// 執行頻率: 日
// 
// _p1參數: 
...
value1 = SimpleHighest(GetField("股價淨值比")[1],days-1);
value2 = value1*(100-_p2)*0.01;
if GetField("股價淨值比") < value1 and GetField("股價淨值比") > value2 then ret=1;