{@type:filter}
// 腳本類型: 選股腳本
// 腳本名稱: N日布林通道寬度小於X%且近Y日趨勢變窄
// 顯示名稱: [20]日布林通道寬度小於[20]%，且近[3]日趨勢變窄
// 執行頻率: 日
// 
// _p1參數: 
// _p1數值: 20,30,50,60
...
// _p3數值: 3,5,10
// 
input: _p1(20), UpperBand(2), LowerBand(2), EMALength(3),_p3(3),_p2(20);
...
If bbandwidth < _p2 and downTrend(bbandwidth,_p3) then ret = 1;