...
if value3 <> 0 then
        value4 = 100*iff(-1=1,value1,value2)/value3
else
        value4 = 0;
value5 = iff(value4[1]<>0,(value4 / absvalue(value4[1]) - sign(value4[1])) * 100,0);
if value5 > _p2 then ret = 1;